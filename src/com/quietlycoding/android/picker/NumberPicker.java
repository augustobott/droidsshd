...
//    @SuppressWarnings({"UnusedDeclaration"})
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // MESTRE
        mText.setKeyListener(new DialerKeyListener());
        if (!isEnabled()) {
            setEnabled(false);
        }
    ...
    public void onClick(View v) {
        ...
        if (v == null) {
        	changeCurrent(Integer.parseInt(mText.getText().toString()));
        } else {
    ...
    protected void validateInput(View v) {
